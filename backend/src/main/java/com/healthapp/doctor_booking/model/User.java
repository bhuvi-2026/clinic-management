...
public class User {
    ...
    public LocalDateTime getLastOtpRequestedAt() {
        return lastOtpRequestedAt;
    }

    public void setLastOtpRequestedAt(LocalDateTime lastOtpRequestedAt) {
        this.lastOtpRequestedAt = lastOtpRequestedAt;
    }

    public Integer getOtpAttemptCount() {
        return otpAttemptCount == null ? 0 : otpAttemptCount;
    }
